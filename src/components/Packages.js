      ...
      <div className="container">
        ...
        <div className="price-row">
          <div className="price-col">
            ...
            <p style={{ letterSpacing: '3px', marginTop: '17px', color: 'black', fontWeight: 'bold' }}>BASIC</p>
            <h3>
              <span>$</span>49
            </h3>
            <ul>
            <hr style={{ width: '200px', backgroundColor: 'grey', opacity: '12%', height: '0.5px' }} className="hr-p"/>
          ...
          <div className="price-col">
            ...
            <p style={{ letterSpacing: '3px', marginTop: '17px', color: 'black', fontWeight: 'bold' }}>PRO</p>
            <h3>
              <span>$</span>129
            </h3>
            <ul>
            <hr style={{ width: '200px', backgroundColor: 'grey', opacity: '12%', height: '0.5px' }}/>
          ...
          <h6>Not sure what to choose? <a href="#contact-us">Contact Us</a></h6>
        </div>
      </div>
    </div>
  );
